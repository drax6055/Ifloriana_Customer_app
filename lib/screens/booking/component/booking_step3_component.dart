...
//                 if (!bookingRequestStore.isPackageReclaim) ApplyCouponComponent(callback: () => setState(() {}),isFromBookingStep3: true,),
...
//                     onChanged: (s) {
//                       num tipAmount = num.tryParse(s) ?? 0;
...
//                             TextPosition(offset: tipController.text.length));
//                       });
